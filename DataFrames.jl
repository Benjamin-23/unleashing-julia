...
# ╔═╡ 52272b2d-67dc-4299-b3d8-721e88625083
begin
	using DataFrames
	using CSV
end
...
# ╔═╡ 1417230d-21c7-49ed-bd52-37481fc6c950
using Plots  # This will install plots

# ╔═╡ 7272ce2c-b17b-49df-8144-0498c1de75f1
using PlutoUI

# ╔═╡ bb2788f2-1772-4435-895f-1801d2b3c2a0
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 4bc93d75-64dc-43cf-b578-1cb3a13e665c
df.Country_code === df[!, "Country_code"]

# ╔═╡ e7ce1988-dda2-4d42-bd74-1b7583b0ffb7
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 855d34fe-4efb-4d71-a059-10fc083427a3
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ c3ca43af-07b3-4ec9-ab24-ed86f1153b33
dates = sg_data[!, "Date_reported"]

# ╔═╡ d12529ba-4d0f-40d9-bbcb-af9c8cc93e57

cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ df22e18f-5b5c-4386-9dfb-f91571662bbe
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 1230f0cc-6e75-40a0-9ca7-5924f3cf6fbc
...
# ╔═╡ 5af88d32-22a3-46ad-b4ed-0420c9d0cda7
